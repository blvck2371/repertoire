...
./scripts/harbor-install.sh 46.101.199.158
```
...
# Remplacer 46.101.199.158 par ton IP
IP=46.101.199.158
...
Modifier les sections suivantes (remplace `46.101.199.158` par ton IP) :
...
```bash
# Linux/Mac
mkdir -p ~/.docker/certs.d/46.101.199.158:4443
scp root@46.101.199.158:/root/harbor/certs/server.crt ~/.docker/certs.d/46.101.199.158:4443/ca.crt

# Puis
docker login 46.101.199.158:4443
```
...
1. Connecte-toi à https://46.101.199.158:4443
